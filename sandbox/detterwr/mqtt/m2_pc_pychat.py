...
Authors: David Fisher and Will Detterman.
...
def main():
    ...
    my_name = "William"  # Used to set the topic that you are *subscribed to* listen to
    team_member_name = "Jabari"  # Used to set the topic that you will *publish to*
